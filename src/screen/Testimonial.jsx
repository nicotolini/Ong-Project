...
export const Testimonial = () => {
  return (
    <section className='h-[650px] bg-white-200  '>
      <div className='lg:absolute flex flex-col top-[10%] 2xl:right-[10%] right-[0] lg:items-start items-center text-center lg:text-start lg:gap-10 gap-5'>
        <h2 className='lg:text-4xl text-3xl font-semibold items-center'>Testimonial</h2>
        <p className='lg:text-2xl text-xl 2xl:max-w-[700px] max-w-[500px] text-shadow px-3'>“Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate human suffering through animal welfare when people might depend on livestock as their only source of income or food.”</p>
      </div>
      <div className='flex flex-wrap  gap-[1px] justify-center'>
        ...
        <Avatar className={"lg:absolute left-[355px] lg:top-[16%] xl:w-[400px] lg:w-[200px] w-[25%]"} image={"./Testinomi1.svg"}/>
      </div>
    </section>
  )
}
