...
const PopularCategories = () => {
  return (
    <section className="bg-violet-100">
      <div className="xl:h-[98vh] h-[178vh] sm:h-[87vh] flex w-full pt-10 sm:pt-0 items-center justify-center clip-path-popular bg-violet-500 ">
        <div className="w-[100%] xl:w-[70%] flex h-[100vh] sm:h-[50%] flex-col xl:flex-row-reverse xl:gap-10  justify-center xl:justify-start">
          <div className="flex-1 flex justify-center lg:mt-5 xl:mt-0 flex-col gap-4 text-center xl:text-start items-center  text-shadow xl:items-start text-white-200  ">
            <h2 className="font-bold text-3xl">Popular Category</h2>
            <p className="md:max-w-2xl xl:max-w-md text-center xl:p-0 p-8 xl:text-start font-semibold ">
