  ...
  return (
    <div className="flex flex-col gap-7 w-full bg-black ">
      ...
      <div className="relative">
        <button className="py-0.5 md:px-[10px] px-2 text-sm md:text-xl bg-violet-200 opacity-85 text-white rounded-[4px] absolute md:top-[14px] top-[15px] right-[8px] cursor-pointer translate-x-[2px]">
          Subcribe
        </button>
        <Input
